...
The New York Times Manual of Style and Usage recommends against using the expression,[60][61] as does the AP Stylebook,[62] and that of The Washington Post.[35] However, the 2018 Polish bill has been condemned by the editorial boards of The Washington Post[35] and The New York Times.[36]"""

)

print(summarize(text,word_count=100))
print("key word:{}".format(keywords(text)))
